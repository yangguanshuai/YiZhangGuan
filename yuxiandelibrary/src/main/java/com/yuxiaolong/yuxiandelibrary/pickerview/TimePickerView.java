package com.yuxiaolong.yuxiandelibrary.pickerview;
...
import com.yuxiaolong.yuxiandelibrary.pickerview.lib.WheelView;
import com.yuxiaolong.yuxiandelibrary.pickerview.listener.CustomListener;
import com.yuxiaolong.yuxiandelibrary.pickerview.view.BasePickerView;
import com.yuxiaolong.yuxiandelibrary.pickerview.view.WheelTime;
...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    public static class Builder {
        ...
        //Required
        public Builder(Context context, OnTimeSelectListener listener, OnCancelListener cancelListener) {
   ...
   public void setDate(Calendar date) {
    ...
    public void cancelData() {
        if (timeSelectListener != null) {
            try {
                ...
                cancelListener.OnCancelListener(date, clickView);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    public interface OnCancelListener {
        void OnCancelListener(Date date, View v);
    }
