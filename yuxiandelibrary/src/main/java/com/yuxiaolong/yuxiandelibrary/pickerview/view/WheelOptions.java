package com.yuxiaolong.yuxiandelibrary.pickerview.view;
...
import com.yuxiaolong.yuxiandelibrary.pickerview.adapter.ArrayWheelAdapter;
import com.yuxiaolong.yuxiandelibrary.pickerview.lib.WheelView;
import com.yuxiaolong.yuxiandelibrary.pickerview.listener.OnItemSelectedListener;
...
public class WheelOptions<T> {
    ...
    public void setPicker(List<T> options1Items,
        ...
        // 选项3
        if (mOptions3Items != null&&mOptions3Items.size()>0&&mOptions3Items.get(0).size()>0)
    ...
    private void itemSelected(int opt1Select, int opt2Select, int opt3Select) {
        ...
        if (mOptions3Items != null&&mOptions3Items.size()>0&&mOptions3Items
