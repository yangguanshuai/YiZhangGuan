...
public class MyOrderAdapter extends BaseCommAdapter<StorageHospitalBase.DataBeanX.DataBean> {
    ...
    public MyOrderAdapter(List<StorageHospitalBase.DataBeanX.DataBean> datas) {
        super(datas);
    }
    ...
    protected void setUI(ViewHolder holder, final int position, final Context context) {
        ...
        status_tv.setText(data.getAcceptanceResult());
        double allPicer = 0;
        ...
        if (data.getAcceptanceResult().equals("待接单")||data.getAcceptanceResult().equals("处理中")){
        ...
        cancel_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (type) {
                    ...
                    //可输入的，提示dialog
                    Intent intent = new Intent(context, InputDialog.class);
                    context.startActivity(intent);
                }
            }
        });
        ...
        if (data.isType()){
            ...
            /*StorageHospitalChildAdapter adapter = new StorageHospitalChildAdapter(data.getDataList());
